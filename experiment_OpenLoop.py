...
def plotPareto():
	name =  ["/home/gabs48/src/SpringMassNetworks/Experiments/Final/paretoCurve1config.csv", \
	"/home/gabs48/src/SpringMassNetworks/Experiments/Final/paretoCurve2config.csv", \
	"/home/gabs48/src/SpringMassNetworks/Experiments/Final/paretoCurve5config.csv", \
	"/home/gabs48/src/SpringMassNetworks/Experiments/Final/paretoCurve10config.csv", \
	"/home/gabs48/src/SpringMassNetworks/Experiments/Final/paretoCurve20config.csv"]
		...
		if loadFile is not None:
			...
			if len(args) > 0:
				...
				for i in range(noTests):
					...
					mapfunc = partial(trainRobot, quickTest = True, movie = False, **kwargs)
...
def trainRobot(iterNum = 0,noNodes = 20, spring = 100, maxAmplitude = 0.25, maxOmega = 10, perf = 'dist', powerRef = None, distRef = None,
					mass = 1, quickTest = True, movie = False, trainFraction = None, fullOutput= False, longTest = False, name = 'default',
